...
/**
 * An agent that negates a numeric value.
 * <p>
 * This agent subscribes to one input topic, negates the received value (changes its sign),
 * and publishes the result to an output topic. It implements the Agent interface
 * and provides negation operation as part of the pub/sub system.
 * <p>
...
public class NegAgent implements Agent {
    ...
    /** The operand for the negation operation */
    ...
    /**
     * Creates a new negation agent with the specified subscribed and published topics.
     *
     ...
     */
    public NegAgent(String[] subscribedTopics, String[] publishedTopics) {
     ...
     * a topic to publish to, negates the value and publishes the result.
     *
    ...
    /**
     * Negates the input value and publishes it to the output topic.
     *
     * @param originalValue The value to negate
     */
    private void publishNegatedValue(double originalValue) {
        result = -originalValue; // Negation operation
    ...
    /**
     * Gets the current result of the negation operation.
     *
     * @return The result of negating the operand
     */
    ...
    /**
     * Sets the result of the negation operation.
     *
