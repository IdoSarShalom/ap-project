...
/**
 * An agent that determines the minimum of two numeric values.
 * <p>
 * This agent subscribes to two input topics, determines the minimum of the received values,
 * and publishes the result to an output topic. It implements the Agent interface
 * and provides minimum operation as part of the pub/sub system.
 * <p>
...
public class MinAgent implements Agent {
    ...
    /** The first operand for minimum operation */
    private Double firstOperand;
    
    /** The second operand for minimum operation */
    ...
    /**
     * Creates a new minimum agent with the specified subscribed and published topics.
     *
     ...
     */
    public MinAgent(String[] subscribedTopics, String[] publishedTopics) {
     ...
     * operands are set, publishes the result of finding their minimum.
     *
    ...
    /**
     * Determines the minimum of the operands and publishes it to the output topic.
     */
    private void publishResult() {
        result = Math.min(firstOperand, secondOperand); // Minimum operation
    ...
    /**
     * Gets the current result of the minimum operation.
     *
     * @return The result of finding the minimum of the operands
     */
    ...
    /**
     * Sets the result of the minimum operation.
     *
