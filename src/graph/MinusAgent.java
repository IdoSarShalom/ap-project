...
/**
 * An agent that subtracts two numeric values.
 * <p>
 * This agent subscribes to two input topics, subtracts the second received value from the first,
 * and publishes the result to an output topic. It implements the Agent interface
 * and provides subtraction operation as part of the pub/sub system.
 * <p>
...
public class MinusAgent implements Agent {
    ...
    /** The first operand for subtraction */
    private Double firstOperand;
    
    /** The second operand for subtraction */
    ...
    /**
     * Creates a new subtraction agent with the specified subscribed and published topics.
     *
     ...
     * operands are set, publishes the result of subtracting the second from the first.
     *
    ...
    /**
     * Calculates the difference between operands and publishes it to the output topic.
     */
    ...
    /**
     * Gets the current result of the subtraction operation.
     *
    ...
    /**
     * Sets the result of the subtraction operation.
     *
